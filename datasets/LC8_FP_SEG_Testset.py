...
import datasets.ext_transforms as et
...
class LC8FPSegDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, is_train, voc_dir, transform=None):
        ...
        images=[i.split('.')[0] for i in os.listdir(PNGImages) if i.find('.png')!=-1]
    ...
    def __getitem__(self, idx):
        ...
        sample = {'img_name':self.img_names[idx], 'image':img, 'label':target}
        return sample
