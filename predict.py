...
from datasets.LC8_FP_SEG_Testset import LC8FPSegDataset
import argparse
...
def save_output(image_name,pred,d_dir,size=(1024,1024)):
...
def get_argparser():
    ...
    parser.add_argument("--model", type=str, default='FPSFormer', help='model name')
...
def main():
    ...
    net = FPSFormer(n_channels=3, phi=opts.phi)
